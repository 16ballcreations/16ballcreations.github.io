/* The banner: the 16 as a real sphere, turning on its vertical axis.
   The library is fetched only where the sphere earns its keep. On a phone
   the ball is 150 px wide, so the flat PNG stays with its CSS spin and the
   page saves the 125 KB of Three.js. Same stand-in if WebGL is missing. */
(function(){
  "use strict";
  ...
  if(window.THREE){ draw(); }
  else {
    var lib = document.createElement("script");
    lib.src = "https://cdnjs.cloudflare.com/ajax/libs/three.js/0.152.2/three.min.js";
